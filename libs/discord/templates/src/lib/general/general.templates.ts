...
export const STEAMID_INSTRUCTIONS_TEMPLATE =
  '**SteamID Instructions**\n\n**1.** Open the Steam application on your computer.\n**2.** Click your profile picture or name at the top right corner.\n**3.** Select "Account Details."\n**4.**Your unique Steam ID will be listed on that page below your username.';

export const EOSID_INSTRUCTIONS_TEMPLATE =
  '**EOS ID Instructions**\n\n**1.** Open the console in Ark using either the Tab key or the ~ key twice.\n**2.** Type "whoami" in the window and hit enter.\n**3.** Your EOS ID will be displayed as a response and automatically copied to your clipboard.';
